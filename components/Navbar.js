...
const Navbar = () => {
    ...
    return (
        <nav className="p-4 bg-background/50 sticky top-0 backdrop-blur border-b z-10 ml-2 mr-2 md:ml-12 md:mr-12 sm:ml-2 sm:mr-2">
            <LoadingBar
                color='#933ce6'
                progress={progress}
            ...
            <div className="container mx-auto flex justify-between items-center">
                <Link href="/">
                    <div className="text-lg font-bold">PulsePost</div>
                </Link>
                <div className="hidden md:flex space-x-4 items-center">
                    ...
                    <Link href="/uploadblog" className="hover:scale-105 hover:font-semibold transition-transform duration-300">UploadBlog</Link>
                ...
                <div className="md:hidden">
                    ...
                    <Sheet>
                        ...
                        <SheetContent>
                            <SheetHeader>
                                <SheetTitle className="font-bold my-4">PulsePost</SheetTitle>
                                <SheetDescription>
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <Link href="/uploadblog">UploadBlog</Link>
                                        <div>
                                            <Link href="/login">
